                    ...
                    <form action="{{route('category.store')}}" method="post">
                        ...
                        <div class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <input type="text" value="{{old("name")}}" id="default-search" name="name" class="block w-full px-2 p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="category name" />
                                @error("name")
