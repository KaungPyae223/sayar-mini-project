                    ...
                    <form action="{{route('category.update',$category->id)}}" method="post">
                        ...
                        <div class="space-y-4">
                            <div class="space-y-2">
                                ...
                                <input type="text" value="{{$category->name}}" id="default-search" name="name" class="block w-full px-2 p-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="category name" required />
                            </div>
                            <div>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Edit</button>
                            </div>
                        </div>
                    </form>
                </div>
