                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="dropzone-file"
                            ...
                            <div id="uploadLabel" class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <div id="imagePreview" style="display: none;" class="flex flex-col items-center justify-center h-full" style="display:none;">
                                <img id="previewImg" src="" class="h-full object-contain" alt="Image preview" style="display:none;">
                              </div>
                ...
                <div class="flex space-x-4 mb-4">
                    ...
                    <div class="flex-1">
                        ...
                        <input type="text" id="product-title" name="title"
                         value="{{old("title")}}"   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
                        @error("title")
                    ...
                    <div class="flex-1">
                        ...
                        <input type="number" id="product-price" name="price"
                          value="{{old("price")}}"  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
                          @error("price")
                    ...
                    <div class="flex-1">
                        ...
                        <input type="number" id="product-stock" name="stock"
                          value="{{old("stock")}}"  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm" />
                          @error("stock")
